...
Spawn the `cascading-style-sheets-inspector` agent to get the actual browser DOM state. Provide it with:
...
The cascading-style-sheets-inspector agent will return computed styles, box model data, the parent chain, layout context, auto-detected issues, and a screenshot. This data is what you base your diagnosis on.
